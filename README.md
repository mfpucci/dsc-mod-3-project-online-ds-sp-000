This project aims to gather insights from a large grocery chain worldwide on its sales and discounting data.  The full code can be viewed in the Northwind Database Analysis.ipynb.
